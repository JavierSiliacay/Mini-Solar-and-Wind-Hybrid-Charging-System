...
2. Open the project folder in your Arduino development environment
3. Connect all hardware components according to the wiring overview
4. Upload the program to the microcontroller
5. Open the Serial Monitor to observe sensor readings and system status
6. Test object detection and LED indicators
